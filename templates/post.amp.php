...
<body>
    ...
    <header class="ampstart-headerbar fixed flex justify-start items-center top-0 left-0 right-0 pl2 pr4 ">
        ...
        <amp-img src="<?php echo( get_header_image() ); ?>" alt="<?php echo( get_bloginfo( 'title' ) ); ?>" width="100" height="61.3" layout="fixed" class="my0 mx-auto "></amp-img>
    </header>
	...
	if ( ! empty( $categories ) ) {
		...
		?>
                    ...
                    <span class="ampstart-subtitle block px3 pt2 mb2"><a href = "<?php 
			echo esc_url( get_category_link( $categories[0]->term_id )); ?>"> <?php echo( esc_html( $categories[0]->name )); ?> </a></span>
                    <?php 
	}

	?>

                        <h1 class="mb1 px3"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h1>

                        <!-- Start byline -->
                        <address class="ampstart-byline clearfix mb4 px3 h5">
	<time class="ampstart-byline-pubdate block bold my1" datetime="<?php echo get_the_date() .' '.get_the_time(); ?>"><?php echo get_the_date().' '. get_the_time(); ?></time>
	</address>
                        <!-- End byline -->
				...
				<?php if ( have_posts() ) : while ( have_posts() ) : the_post();
					the_content();
				endwhile; else: ?>
					<p>Sorry, no posts to display here.</p>
				<?php endif; ?>
    ...
    <!-- Start Footer -->
    <!-- You can add your company or website details here !-->
    <!-- End Footer -->
</body>
